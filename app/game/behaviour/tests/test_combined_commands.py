...
from app.autogenerated.adapters.can_change_velocity_adapter import CanChangeVelocityAdapter
from app.autogenerated.adapters.consumes_fuel_adapter import ConsumesFuelAdapter
from app.autogenerated.adapters.movable_adapter import MovableAdapter
...
def test_move_and_burn_fuel() -> None:
    ...
    fuel_consumer = ConsumesFuelAdapter(uobj)
